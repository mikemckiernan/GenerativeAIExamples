...
type Options struct {
       ValueFiles   []string `json:"valueFiles"`  // -f/--values
       StringValues []string `json:"strinValues"` // --set-string
       Values       []string `json:"values"`      // --set
       FileValues   []string `json:"fileValues"`  // --set-file
       JSONValues   []string `json:"JSONValues"`  // --set-json
}
